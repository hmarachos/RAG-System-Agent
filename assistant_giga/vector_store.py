"""
Модуль работы с векторным хранилищем Qdrant для GigaChat.
...
class VectorStore:
    """Векторное хранилище на основе Qdrant с GigaChat embeddings."""
    ...
    def __init__(self, collection_name: str = "rag_collection", persist_directory: str = "./qdrant_db"):
        ...
        # Размерность векторов для GigaChat embeddings (обычно 768)
    ...
    def load_documents(self, file_path: str):
        ...
        for i, chunk in enumerate(chunks):
            # Создание embedding через GigaChat
...
if __name__ == "__main__":
    ...
    if not os.getenv("GIGACHAT_AUTH_KEY"):
        print("Ошибка: установите переменную окружения GIGACHAT_AUTH_KEY")
        sys.exit(1)
